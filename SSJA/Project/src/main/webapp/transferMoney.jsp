...
<body>
	...
	<div class="d-flex wrapper1">
		...
		<div id="content" class="p-4 p-md-5 pt-5">
			...
			<div class="wrapper">
				<form action="TransferMoneyServlet" id="wizard" method="post">
					<!-- SECTION 1 -->
								...
								<div class="form-row1">
									<div class="select">
										<div class="form-holder1">
											<select name="tsfAccount" class="select-control"
												style="border: none;">
												<option value="000">Your Account Number</option>
												<%
												for (AccountInfo acinfo : list) {
													if (acinfo.getSignUpInfo().getUserName().equals(str)) {
														username = acinfo.getName();
												%>
												<option value="<%=acinfo.getAccountNumber() %>"><%=acinfo.getAccountNumber() %></option>
												<%
												}
									...
									<div class="form-holder1">
										<div class="form-holder1">
											<input name="tsfRecAccount" type="number"
												placeholder="Receivers Account Number" class="form-control1">
										</div>
									</div>
								</div>
								<div class="form-row1">
									<div class="form-holder1">
										<input name="tsfAmount" type="number"
											placeholder="Amount (50000)" class="form-control1">
									</div>
									<div class="form-holder1">
										<input name="tsfPin" type="password" placeholder="Enter PIN"
											class="form-control1">
									</div>
								</div>
