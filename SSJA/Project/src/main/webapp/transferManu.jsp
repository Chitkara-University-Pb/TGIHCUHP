		...
		<div id="content" class="p-4 p-md-5 pt-5">
			...
			<div class="d-flex flex-wrap p-4">
                <div class="card m-3" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">Transfer within the bank</h5>
                        <p class="card-text">( Re. 1 Onwords )</p>
                        <a href="#" style="margin-left:80px;">View Demo</a><br><br>
                        <a href="transferMoney.jsp" class="btn btn-primary" style="margin-left:100px;"> Go </a>
                    </div>
                </div>

                <div class="card m-3" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">IMPS P2A-Instant Transfer</h5>
                        <p class="card-text">( Re. 1 Onwords )</p><br>
                        <p class="card-text">( IMPS - Account No )</p>
                        <a href="#" style="margin-left:80px;">View Demo</a><br><br>
                ...
                <div class="card m-3" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">Transfer to other bank(NEFT)</h5>
                        <p class="card-text">(Also for cradit card payment)</p><br>
                        <p class="card-text">( Re. 1 Onwords )</p>
                        <a href="#" style="margin-left:80px;">View Demo</a><br><br>
                        <a href="transferMoney.jsp" class="btn btn-primary" style="margin-left:100px;"> Go </a>
                    </div>
                ...
                <div class="card m-3" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">Transfer to other bank(RTGS)</h5>
                        <p class="card-text">( Rs 2 Lacs Onwords )</p>
                        <a href="#" style="margin-left:80px;">View Demo</a><br><br>
                        <a href="transferMoney.jsp" class="btn btn-primary" style="margin-left:100px;"> Go </a>
                    </div>
                </div>
                ...
                <div class="card m-3" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">IMPS P2A-Instant Transfer</h5>
                        <p class="card-text">( IMPS Mobile Number )</p>
                        <a href="#" style="margin-left:80px;">View Demo</a><br><br>
                        <a href="#" class="btn btn-primary" style="margin-left:100px;"> Go </a>
                    </div>
                </div>
                ...
                <div class="card m-3" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">Transfer to eCMS Account</h5>
                        <p class="card-text">(Virtual Account)</p>
                        <p class="card-text">( Re. 1 Onwords )</p>
                        <a href="#" style="margin-left:80px;">View Demo</a><br><br>
                        <a href="#" class="btn btn-primary" style="margin-left:100px;"> Go </a>
                    </div>
                ...
                <div class="card m-3" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">RemitNow</h5>
                        <p class="card-text">( Foreign Outward Remittance for resident individuals only )</p>
                        <a href="#" style="margin-left:80px;">View Demo</a><br><br>
                        <a href="#" class="btn btn-primary" style="margin-left:100px;"> Go </a>
                    </div>
                </div>
                ...
                <div class="card m-3" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">Cardless Cash Withdrawal</h5>
                        <p class="card-text"></p>
                        <a href="#" style="margin-left:80px;"></a><br><br>
                        <a href="#" class="btn btn-primary" style="margin-left:100px;"> Go </a>
                    </div>
                </div>
